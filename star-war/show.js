$ (function ()
		{
		var frames =[]; var LINES_PER_FRAME = 14; var DELAY = 67;
		...
		{
		var i = 0; var next_delay; if (delay == undefined)
		{
		delay = DELAY;}
		function display ()
		{
			...
			{
				i = 0;}
			term.clear (); if (frames[i][0].match (/[0 - 9] + /))
			{
...
$ ('#starwarsterm').terminal (function (command, term)
		...
		if (command == 'play')
		{
		term.pause (); stop = false; play (term);}
		}
		,
		{
width: 500, height: 230, prompt: 'starwars> ', greetings: null, onInit:function
(term)
{
greetings (term);}
...
{
stop = true; term.resume (); return false;}
}
}
);}
